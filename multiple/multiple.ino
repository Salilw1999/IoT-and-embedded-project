...
void sendSOS() {
  ...
  // Replace <PHONE_NUMBER1>, <PHONE_NUMBER2>, <PHONE_NUMBER3> with the recipient's phone numbers
  String recipients[] = {"+917620287909", "+917350002966", "+917507153462"};

  for (int i = 0; i < sizeof(recipients) / sizeof(recipients[0]); i++) {
    SIM800L.print("AT+CMGS=\"");
    SIM800L.print(recipients[i]);
    SIM800L.println("\"\r");
    delay(1000);
