...
#define BLYNK_TEMPLATE_ID "TMPL3MdFvay4r"
#define BLYNK_TEMPLATE_NAME "GPS"
#define BLYNK_AUTH_TOKEN "wxKWxChmccjy1eQ1Jua6i7DVumrUIYCX"
...
static const int RXPin = 3, TXPin = 1;   // GPIO 4=D2(conneect Tx of GPS) and GPIO 5=D1(Connect Rx of GPS
...
char auth[] = "wxKWxChmccjy1eQ1Jua6i7DVumrUIYCX";            //Blynk Authentication Token
char ssid[] = "Salil OnePlus";            // WiFi SSID
